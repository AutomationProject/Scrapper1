...
public class Illustrator_help {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.get("http://www.webdesignforums.net/forum/adobe-illustrator-help/");
						...
						if (!href
							...
							try {
								FileInputStream file = new FileInputStream(
										new File("adobe-illustrator-help.xls"));
