...
public class Articles_Tutorials {
	static int COUNT;
	...
	public static void main(String[] args) throws Exception {
		...
		driver.get("http://www.webdesignforums.net/forum/articles-tutorials/");

		/*
		 * Thread.sleep(6000); System.out.println(driver.findElement(
		 * By.xpath("//div[@class='threadinfo']/a")).getAttribute("href"));
		 */
		Thread.sleep(6000);
						...
						if (!href
							...
							try {
								FileInputStream file = new FileInputStream(
										new File("articles-tutorials.xls"));
