...
public class General_Web_Design_Discussion {
	static int COUNT;
	...
	public static void main(String[] args) throws Exception {
		...
		driver.get("http://www.webdesignforums.net/forum/general-web-design-discussion/");
						...
						if (!href
							...
							try {
								FileInputStream file = new FileInputStream(
										new File(
												"general-web-design-discussion.xls"));
