...
public class website_ratings_reviews {
	static int COUNT;
	...
	public static void main(String[] args) throws Exception {
		...
		driver.get("http://www.webdesignforums.net/forum/website-ratings-reviews/");
						...
						if (!href
							...
							try {
								FileInputStream file = new FileInputStream(
										new File("website-ratings-reviews.xls"));
