...
public class Database_Help {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.get("http://www.webdesignforums.net/forum/database-systems-help/");
						...
						if (!href
							...
							try {
								FileInputStream file = new FileInputStream(
										new File("database-systems-help.xls"));
