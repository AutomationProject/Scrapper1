...
public class Flash_Help {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.get("http://www.webdesignforums.net/forum/adobe-flash-help/");
		...
		for (int i = 0; i <= Integer.parseInt(noofresults); i++) {
			...
			// if (!hrefquery.equals(null) || hrefquery.length() != 0)
			{
