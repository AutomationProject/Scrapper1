...
public class Photoshop_Help {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.get("http://www.webdesignforums.net/forum/adobe-photoshop-help/");
						...
						if (!href
							...
							try {
								FileInputStream file = new FileInputStream(
										new File("adobe-photoshop-help.xls"));
